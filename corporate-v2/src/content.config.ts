...
const people = defineCollection({
	...
	schema: z.object({
		...
		historicalRole: z.string().optional(),
		historicalAlias: z.string().optional(),
		historicalBio: z.string().optional(),
		historicalMetadataStatus: z.enum(['documented', 'owner_confirmed', 'needs_review']).optional(),
