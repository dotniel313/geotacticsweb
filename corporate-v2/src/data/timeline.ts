...
export const timelineEvents: TimelineEvent[] = [
	...
	},
	{
		...
		summary: 'Nace GOST como marco para comprender y estructurar problemas antes de convertirlos en sistemas.',
		home: true,
		track: 'method',
		products: [],
		cases: [],
	...
	},
	{
		...
		title: 'YAKU · EMAPAI',
		summary: 'Gestión institucional y explotación analítica de información con YAKU.',
		home: false,
		track: 'record',
		products: ['yaku'],
		cases: ['emapai-yaku'],
	...
	},
	{
		...
		summary: 'GeoTactics consolida su base en Nueva Loja, Sucumbíos.',
		home: true,
		track: 'method',
		products: [],
		cases: [],
