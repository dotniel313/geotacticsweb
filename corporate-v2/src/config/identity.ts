/**
 * Corporate identity — 3.8.0-beta.1
 * Purpose / mission / vision: OWNER_APPROVED (addendum 2026-09).
 */
...
export const identity = {
	...
	missionLabel: 'Misión',
	missionStatus: 'OWNER_APPROVED' as const,
	mission:
		'Transformamos problemas reales en sistemas que permiten comprender mejor, gestionar mejor y tomar mejores decisiones.\n\nIntegramos información, territorio, procesos y tecnología para construir soluciones que mejoren los resultados de organizaciones públicas y privadas.',
	visionLabel: 'Visión',
	visionStatus: 'OWNER_APPROVED' as const,
	vision:
	...
	homeBeats: [
		...
		{ code: 'CONTINUIDAD', text: 'Las tecnologías cambiaron. La idea central no.' },
	],
	homeCta: 'La empresa',
} as const;
